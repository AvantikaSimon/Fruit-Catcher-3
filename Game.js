    ...
    play(){
        ...
        for(var plr in allPlayers){
           ...
           players[index - 1].y = y;
            ...
            textSize(20);
            text("Score: " + player[0].score, players[0].x, players[0].y)
            text("Score: " + player[1].score, player[1].x, player[1].y);
        ...
        if(fruitsGroup.isTouching(players[index - 1])){
           ...
           players[index - 1].score += 1;
           
        }

        if(player.index !== null){
          for(var i = 0; i < fruitsGroup.length; i++){
              fruitsGroup.get(i).isTouching(players);
              fruitsGroup.get(i).destroy();
              players[index - 1].score += 1;
              player[index - 1].score.update();
              database.ref('player').score.update();
          }
        }
       ...
       textSize(30);
       text("Winner: " + player.name, 450, 400);
